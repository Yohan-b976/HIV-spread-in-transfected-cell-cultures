...
def diffusion(virus_density, D, dx, t, n,alpha):
...
def diffusion_dif_pop_virus(virus_density, m_virus, D, dx, t, n,alpha):
    ...
    for rep in range(n):
        virus_density = diffusion(virus_density, D, dx, t, n, alpha) 
...
def simulate_infection_with_diffusion(grid_size, N_initial, dx, t, n, alpha, Liste_retour_24, Liste_retour_48, Liste_retour_72, Liste_retour_96):
    ...
    for t_step in range(timesteps):
        ...
        new_virus_density, new_maturation_virus = diffusion_dif_pop_virus(new_virus_density, new_maturation_virus, D, dx, t, n, alpha)
...
###############################################################################
Alpha = np.linspace(0.001, 0.8, 20)
Liste_retour_24 = []
Liste_retour_48 = []
Liste_retour_72 = []
Liste_retour_96 = []
...
for alp in Alpha:
    for kelp in range(n_repetitions):
        ...
        simulate_infection_with_diffusion(grid_size, N_initial, dx, t, n, alp, Liste_retour_24, Liste_retour_48, Liste_retour_72, Liste_retour_96)
...
plt.plot(Alpha,Moyenne_infection_24h, label='24h')
plt.plot(Alpha,Moyenne_infection_48h, label='48h')
plt.plot(Alpha,Moyenne_infection_72h, label='72h')
plt.plot(Alpha,Moyenne_infection_96h, label='96h')


# Ajouter des labels et des légendes
plt.xlabel('valeur de alpha')
plt.ylabel('Pourcentage de cellule GFP+')
plt.title('Impact de alpha sur infection ')
plt.legend()
plt.grid(True)
