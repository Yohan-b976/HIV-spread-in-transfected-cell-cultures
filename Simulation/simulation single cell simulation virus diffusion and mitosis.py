...
def simulate_infection_with_diffusion(grid_size, N_initial, dx, t, n):
    ...
    for t_step in range(timesteps):
        ...
        if t_step == 24 or t_step == 48 or t_step == 72 or t_step == 95 or t_step == 121:
