...
###### Paramètres pour gérer les transfectées et la réplication du virus
...
n_repetitions = 6 # nombre de répétitions pour faire la moyenne
...
def simulate_infection_with_diffusion(grid_size, N_initial, dx, t, n, coef_de_transfectees, Liste_infection_24h, Liste_infection_48h, Liste_infection_72h, Liste_infection_96h):
...
for coef_de_transfectees in P_transfecte:
    for repeat in range(n_repetitions):
        
        Liste_infection_24h, Liste_infection_48h, Liste_infection_72h, Liste_infection_96h = simulate_infection_with_diffusion(grid_size, N_initial, dx, t, n, coef_de_transfectees,Liste_infection_24h, Liste_infection_48h, Liste_infection_72h, Liste_infection_96h)
