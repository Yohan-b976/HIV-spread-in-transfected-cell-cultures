...
V = 1000  # Nombre moyen de particules virales produites par virion incell
s = 0.0014  # Probabilité d'infection par contact
k = 4  # Nombre moyen de contacts par particule virale
Rmax = 5000  # Valeur de coupure maximale pour le taux de réplication
...
ksj = 0.4  # Paramètre composite pour simplifier le modèle
