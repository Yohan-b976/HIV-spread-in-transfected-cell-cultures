# -*- coding: utf-8 -*-
"""
Created on Tue Oct 22 11:55:19 2024
...
def simulate_infection_with_diffusion(grid_size, N_initial, dx, t, n, data_virus, data_cell):
    ...
    for t_step in range(timesteps):
        ...
        virus_density_total = virus_density + number_virion_maturing
        ...
        plt.imshow(virus_density_total, cmap='inferno', interpolation='nearest')
        plt.title(f'Densité virale {t_step}')
        plt.colorbar()
        plt.show()
        
        data_virus += [virus_density_total]
    ...
    plt.show()
    return state, virus_density_total
...
final_state, final_virus_density = simulate_infection_with_diffusion(grid_size, N_initial, dx, t, n, data_virus, data_cell)
...
ani.save('simulation_virus1.mp4', writer='ffmpeg')
...
# Sauvegarde en vidéo (mp4)
ani.save('simulation_cell_100.mp4', writer='ffmpeg')
