...
k = 5  # Nombre moyen de contacts par particule virale
Rmax = 15000  # Valeur de coupure maximale pour le taux de réplication
mu = 0.033 # Probabilité de mort d'une cellule infectieuse
...
perte = 0.3567 # Coefficient de perte à chaque propagation virus mature
perte_mat = 0.0008 # Coefficient de perte à chaque propagation virus non mature
virus_entrant = 1
temps_vie_virus = 24
temps_maturation_virus = 3 # en réalité n-1
...
tps_prod_GFP = 19 # délai avant l'apparition d'une fluorescence
...
dx =  3e-6  # Taille des cellules sur la grille
t = 1.0  # Temps total de simulation
n = 40  # Nombre de subdivisions temporelles (donc dt = t/n)
